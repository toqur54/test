...
<body onload="board_insert.b_title.focus()">
<form  id="board_insert" name="board_insert" method="post" action="board_insert" data-parsley-validate="true"
	...
	<div class="container" style="margin-top: 100px">
		...
		<div class="row">
			...
			<div class="input-group mb-3 col-md-6 ">
				...
				<input type="text" id="b_email" name="b_email" class="form-control" readonly="readonly"
					placeholder="E-Mail" aria-label="Useremail" value="${sessionemail}"
		...
		<div class="row">
			...
			<div class="input-group mb-3 col-md-6 ">
				...
				<input id="b_name" name="b_name" type="text" class="form-control" readonly="readonly" placeholder="Name" value="${sessionname}" aria-label="Username" aria-describedby="basic-addon1">
			</div>
			<div class="col-md-3"></div>
		</div>
		...
		<div class="row" style="margin-bottom: 100px; margin-top: 20px">
			...
			<div class="col-md-4">
				<button id="save_btn" name="save_btn" type="submit" class="btn btn-info save" style="margin-right: 10px; color: #000000">저  장</button>
