...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#delete_btn').on('click', function() {
			...
			$('.modal_btn2').text("취소");
			$('.modal_btn1').on('click',function(){
				var url = "user_delete?code="+$('#code').val();
...
<body>
	<form id="user_update_form" name="user_update_form" method="post" action="user_update_form" data-parsley-validate="true"
		...
		<div class="container" style="margin-top: 20px">
			...
			<div class="row">
				...
				<div class="input-group mb-3 col-md-6 ">
					...
					<input id="code" name="code" type="text" readonly="readonly" class="form-control" value="${user.code}" placeholder="code" aria-label="Userpass" aria-describedby="basic-addon1" required="true"
			...
			<div class="row">
				...
				<div class="input-group mb-3 col-md-6 ">
					...
					<input id="name" name="name" type="text" class="form-control" value="${user.name}" placeholder="name" aria-label="Userpass" aria-describedby="basic-addon1" required="true"
			...
			<div class="row">
				...
				<div class="input-group mb-3 col-md-6 ">
					...
					<input id="age" name="age" type="text" class="form-control" value="${user.age}"	placeholder="age" aria-label="Userpass" aria-describedby="basic-addon1" required="true"
...
<%-- 					<c:if test="${user.gender == '남자'}"> --%>
<!-- 						<input id="gender" name="gender" value="남자" type="radio" checked="checked" class="form-control" -->
<!-- 								aria-describedby="basic-addon1" />남자 -->
<!-- 							<input id="gender" name="gender" value="여자" type="radio" class="form-control" aria-describedby="basic-addon1" />여자 -->
<%-- 					</c:if> --%>
<%-- 					<c:if test="${user.gender == '여자'}"> --%>
<!-- 						<input  id="gender" name="gender" type="radio" name="gender" value="남자" class="form-control" -->
<!-- 								aria-describedby="basic-addon1">남자 -->
<!-- 							<input  id="gender" name="gender" type="radio" name="gender" value="여자" checked="checked" class="form-control" -->
<!-- 								aria-describedby="basic-addon1">여자 -->
<%-- 					</c:if> --%>
					<c:choose>
						<c:when test="${(user.gender).equals('남자')}">
							<input id="gender" name="gender" value="남자" type="radio" checked="checked" class="form-control" aria-describedby="basic-addon1" />남자
							<input id="gender" name="gender" value="여자" type="radio" class="form-control" aria-describedby="basic-addon1" />여자
						</c:when>
						<c:otherwise>
							<input  id="gender" name="gender" type="radio" name="gender" value="남자" class="form-control" aria-describedby="basic-addon1">남자
							<input  id="gender" name="gender" type="radio" name="gender" value="여자" checked="checked" class="form-control" aria-describedby="basic-addon1">여자
						</c:otherwise>
					</c:choose>
				</div>
				<div class="col-md-3"></div>
			...
			<div class="row" style="margin-bottom: 100px; margin-top: 20px">
				...
				<div class="col-md-4">
					...
					<button id="delete_btn" name="delete_btn" type="button"	class="btn btn-success save" style="margin-right: 10px; color: #000000">삭 제</button>
					<button id="cancel_btn" name="cancel_btn" type="reset" class="btn btn-primary save" style="margin-right: 10px; color: #000000">취 소</button>
				</div>
				<div class="col-md-3"></div>
			</div>
